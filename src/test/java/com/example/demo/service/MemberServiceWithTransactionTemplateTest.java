...
class MemberServiceWithTransactionTemplateTest {
    public static final String MEMBER_A ="memberA";
    public static final String MEMBER_B ="memberB";
    public static final String MEMBER_EX = "ex";

    private MemberRepositoryV3 memberRepository;
    private MemberServiceWithTransactionTemplate memberService;
    ...
    void before(){
        ...
        memberService = new MemberServiceWithTransactionTemplate(transactionManager, memberRepository);
    }
