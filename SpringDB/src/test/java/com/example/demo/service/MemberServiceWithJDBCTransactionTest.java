...
class MemberServiceWithJDBCTransactionTest {
    public static final String MEMBER_A ="memberA";
    public static final String MEMBER_B ="memberB";
    public static final String MEMBER_EX = "ex";

    private MemberRepositoryV2 memberRepositoryV2;
    private MemberServiceWithJDBCTransaction memberServiceWithJDBCTransaction;

    @BeforeEach
    void before(){
        DriverManagerDataSource dataSource = new DriverManagerDataSource(URL, USERNAME, PASSWORD);
        memberRepositoryV2 = new MemberRepositoryV2(dataSource);
        memberServiceWithJDBCTransaction = new MemberServiceWithJDBCTransaction(dataSource, memberRepositoryV2);
    }
    ...
    void accountTransfer() throws SQLException {
        ...
        //when
        memberServiceWithJDBCTransaction.accountTransfer(memberA.getMemberId(), memberB.getMemberId(), 2000);
    ...
    void accountTransferEx() throws SQLException {
        ...
        //when
        Assertions.assertThatThrownBy(() -> memberServiceWithJDBCTransaction.accountTransfer(memberA.getMemberId(), membereX.getMemberId(), 2000))
